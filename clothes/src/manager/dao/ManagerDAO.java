...
public class ManagerDAO {
	...
	public int getClothesCount(String clothes_kind) throws Exception {
		Connection conn = null;
		PreparedStatement pstmt = null;
		ResultSet rs = null;
	...
	public ManagerVO[] getClothess(String clothes_kind, int count) throws Exception {
		Connection conn = null;
		PreparedStatement pstmt = null;
		ResultSet rs = null;
	...
	public ManagerVO getClothes(int clothesId) throws Exception {
		...
		try {
			...
			pstmt = conn.prepareStatement("select * from clothes where clothes_id = ?");
	...
	public void updateClothes(ManagerVO clothes, int clothesId) throws Exception {
		Connection conn = null;
		PreparedStatement pstmt = null;
		String sql;
		...
		try {
			...
			sql += ",clothes_count=?,clothes_size=?";
	...
	public void deleteClothes(int clothesId) throws Exception {
		Connection conn = null;
		PreparedStatement pstmt = null;
		ResultSet rs = null;
		...
		try {
			...
			pstmt = conn.prepareStatement("delete from clothes where clothes_id=?");
			pstmt.setInt(1, clothesId);
